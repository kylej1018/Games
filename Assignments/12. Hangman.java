 ...
 *   hint: boolean b = Character.isLetter(c); will be true if c is a letter
 * It should display nicely on the screen - if it's more than 40 chars, start a new line at the next space.
