...
public class Loops4 {
	...
	public static void main (String [] args) {
		...
		// #22. Find and delete duplicates in stringArray1 {abc, def, ghi, jkl, abc, mno} --> {abc, def, ghi, jkl, mno}
		// #23. Add elements to stringArray2 so all have same number of entries as letters in name {a, bc, def, gh} --> {a, bc, bc, def, def, def, gh, gh}
		// #24. Create an arraylist spelling numbers in unsortedIntArray {1, 2, 3, 4} --> {one, two, three, four}
		// #25. Alphabetize stringArray2 "insertsort", where the next element is placed in a new array between already alphabetically organized words.
		// #26. Invert each word in stringArray2 {the quick brown fox} --> {eht kciuq nworb xof}
		// #27. Make an array of only the palindromes in stringArray2
  }
