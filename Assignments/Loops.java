...
Starting in lesson 2, you'll use printArray(myArray).  By the end of Lesson 5, you'll be able to look at printArray and understand how I made it.
...
ArrayList <String> arr = new ArrayList<String>();
Then if you want to add something, it looks like arr.add("My first list!");
If you want to add it at a certain index (say 0), it looks like arr.add(0, "This is added at the first spot, which is index 0");
